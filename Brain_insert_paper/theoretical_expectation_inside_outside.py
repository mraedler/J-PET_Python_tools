...
def main():
    ...
    print(np.trapezoid(d_all_6_30 * fwhm_2, x=p_over_l) / np.trapezoid(d_all_6_30, x=p_over_l))
    print(np.trapezoid(d_tbtb_6_30 * fwhm_2, x=p_over_l) / np.trapezoid(d_tbtb_6_30, x=p_over_l))
    print(np.trapezoid(d_tbbi_6_30 * fwhm_2, x=p_over_l) / np.trapezoid(d_tbbi_6_30, x=p_over_l))
    print(np.trapezoid(d_bibi_6_30 * fwhm_2, x=p_over_l) / np.trapezoid(d_bibi_6_30, x=p_over_l))
    print()

    print((np.trapezoid(d_tbtb_4_18 * (fwhm_2 * 1 + 0), x=p_over_l) + np.trapezoid(d_tbbi_4_18 * (fwhm_12 * 1 + 0), x=p_over_l) + np.trapezoid(d_bibi_4_18 * (fwhm_1 * 1 + 0), x=p_over_l)) / np.trapezoid(d_all_4_18, x=p_over_l))
    print(np.trapezoid(d_tbtb_4_18 * fwhm_2, x=p_over_l) / np.trapezoid(d_tbtb_4_18, x=p_over_l))
    print(np.trapezoid(d_tbbi_4_18 * fwhm_12, x=p_over_l) / np.trapezoid(d_tbbi_4_18, x=p_over_l))
    print(np.trapezoid(d_bibi_4_18 * fwhm_1, x=p_over_l) / np.trapezoid(d_bibi_4_18, x=p_over_l))
    print()
    print(np.trapezoid(d_tbbi_4_18 * p_over_l, x=p_over_l) / np.trapezoid(d_tbbi_4_18, x=p_over_l))
    print(np.trapezoid(d_tbbi_6_30 * p_over_l, x=p_over_l) / np.trapezoid(d_tbbi_6_30, x=p_over_l))

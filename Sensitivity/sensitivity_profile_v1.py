...
def main():
    ...
    tbtb_true, tbbi_true, bibi_true, z_edges = load_tb_j_pet_brain_insert_th3d(
        output_dir + '/Sensitivity_line_source_200_ps/2026-01-22_10-38-35_copy', 'true', return_grid=True)

    tbtb_energy, tbbi_energy, bibi_energy = load_tb_j_pet_brain_insert_th3d(
        output_dir + '/Sensitivity_line_source_200_ps/2026-01-22_10-38-35_copy', 'energy')
    tbtb_energy_true, tbbi_energy_true, bibi_energy_true = load_tb_j_pet_brain_insert_th3d(
        output_dir + '/Sensitivity_line_source_200_ps/2026-01-22_10-38-35_copy', 'energy_true')

    tbtb_time, tbbi_time, bibi_time = load_tb_j_pet_brain_insert_th3d(
        output_dir + '/Sensitivity_line_source_200_ps/2026-01-22_10-38-35_copy', 'time')
    tbtb_time_true, tbbi_time_true, bibi_time_true = load_tb_j_pet_brain_insert_th3d(
        output_dir + '/Sensitivity_line_source_200_ps/2026-01-22_10-38-35_copy', 'time_true')

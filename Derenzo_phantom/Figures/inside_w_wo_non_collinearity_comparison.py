"""
Compare the resolution inside the brain insert with and without non-collinearity
...
def main():
    ...
    img_nc_all_true = load_derenzo_image('/Derenzo_400_ps_4_18_mm_non_collinearity/2026-02-22_12-10-48/ALL_true', it=it)
    img_nc_tbtb_true = load_derenzo_image('/Derenzo_400_ps_4_18_mm_non_collinearity/2026-02-22_12-10-48/TB-TB_true', it=it)
    img_nc_tbbi_true = load_derenzo_image('/Derenzo_400_ps_4_18_mm_non_collinearity/2026-02-22_12-10-48/TB-BI_true', it=it)
    img_nc_bibi_true = load_derenzo_image('/Derenzo_400_ps_4_18_mm_non_collinearity/2026-02-22_12-10-48/BI-BI_true', it=it)

    # img_nc_all_energy = load_derenzo_image('/Derenzo_400_ps_4_18_mm_non_collinearity/2026-02-22_12-10-48/ALL_energy', it=it)
    img_nc_tbtb_energy = load_derenzo_image('/Derenzo_400_ps_4_18_mm_non_collinearity/2026-02-22_12-10-48/TB-TB_energy', it=it)
    # img_nc_tbbi_energy = load_derenzo_image('/Derenzo_400_ps_4_18_mm_non_collinearity/2026-02-22_12-10-48/TB-BI_energy', it=it)
    img_nc_bibi_energy = load_derenzo_image('/Derenzo_400_ps_4_18_mm_non_collinearity/2026-02-22_12-10-48/BI-BI_energy', it=it)

    images = [img_all_true, img_tbtb_true, img_tbbi_true, img_bibi_true,
              img_nc_all_true, img_nc_tbtb_true, img_nc_tbbi_true, img_nc_bibi_true]
    ...
    ax.legend([p1, p2], ['W/o', 'W/'], loc='lower left', frameon=False, title='Non-col.')
    # ax.legend([p1, p2], ['W/o', 'W/'], loc='lower left', frameon=False, title='Non-collinearity')

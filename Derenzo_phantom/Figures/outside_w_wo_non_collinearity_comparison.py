"""
Compare the resolution outside the brain insert with and without non-collinearity
...
def main():
    ...
    img_nc_tbtb_true_outside = load_derenzo_image('/Derenzo_400_ps_4_18_mm_outside_non_collinearity/2026-02-21_20-22-47/TB-TB_true', z_offset=755., it=it)
    img_nc_tbtb_energy_outside = load_derenzo_image('/Derenzo_400_ps_4_18_mm_outside_non_collinearity/2026-02-21_20-22-47/TB-TB_energy', z_offset=755., it=it)

    # vis_3d(img_tbtb_energy_outside)
    # vis_3d(img_tbtb_energy_outside2)

    # images = [img_tbtb_true_outside, img_nc_tbtb_true_outside]
    images = [img_tbtb_energy_outside, img_nc_tbtb_energy_outside]
